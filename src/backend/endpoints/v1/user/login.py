...
from response.schemas.authorize_schema import OAuth2ResponseSchema, OAuth2WechatInfoResponseSchema
from response.schemas.stdresp import StdResp

token_router = APIRouter(tags=['授权'])


@token_router.post("/token", response_model=OAuth2ResponseSchema)
